...
const WORDPRESS_PLUGINS = [
  { id: 'gravity', name: 'Gravity Forms', icon: '🔷' },
  { id: 'wpforms', name: 'WPForms', icon: '🟠' },
  { id: 'contact7', name: 'Contact Form 7', icon: '🔵' },
  { id: 'ninja', name: 'Ninja Forms', icon: '🟣' },
...
export function ExportModal({ form, isOpen, onClose, formData = {} }: ExportModalProps) {
  ...
  const handlePdfExport = async () => {
    ...
    try {
      ...
      // Footer
      const footerY = 40
      page.drawText(`Generated by RevoForms • ${new Date().toLocaleDateString()}`, { x: margin, y: footerY, size: 9, font, color: rgb(0.6, 0.6, 0.6) })
              ...
              {activeTab === 'pdf' && (
                <div className="space-y-4">
                  ...
                  <button onClick={handlePdfExport} disabled={isGeneratingPdf}
                    ...
                    {isGeneratingPdf ? <span className="animate-spin">⏳</span> : <Download className="w-5 h-5" />}
